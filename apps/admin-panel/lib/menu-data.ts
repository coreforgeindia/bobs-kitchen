...
// Curated reliable high-resolution food images from static public assets & Unsplash
const images = {
  paneerSnackPack: '/veg-snack-pack.jpg',
  ...
  vegBurger: '/veg_burger.png',
  chickenBurger: '/chicken_burger.png',
  crunchyPaneerRoll: '/crunchy_paneer_wrap.png',
  tawaChickenRoll: '/tawa_grilled_chicken_wrap.png',
  chickenJalfreziRoll: '/chicken_jalfrezi_wrap.png',
  periPeriFries: '/peri_peri_fries.png',
  ...
  smilies: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?auto=format&fit=crop&w=800&q=80',
  cheeseSandwich: '/cheese_sandwich.png',
  paneerSandwich: '/paneer_tikka_sandwich.png',
  chickenSandwich: '/chicken_tikka_sandwich.png',
  chickenJalfreziSandwich: '/chicken_jalfrezi_sandwich.png',
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    name: 'Tawa Grilled Chicken Wrap',
    category: 'Rolls',
    price: 149,
    originalPrice: 199,
  ...
  },
  {
    ...
    image: images.chickenJalfreziSandwich,
    veg: false,
    rating: 4.7,
    reviewCount: 380,
    calories: 420,
