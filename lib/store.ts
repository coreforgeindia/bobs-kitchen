...
const initialOrders: Order[] = [
  {
    id: 'BSK-876162',
    items: [
      { id: 'chicken-burger', name: 'Chicken Burger', category: 'Burgers', price: 99, description: '', image: '/chicken-burger.png', veg: false, rating: 4.9, calories: 460, time: '15 min', quantity: 1 },
      { id: 'peri-peri-french-fries', name: 'Peri Peri French Fries', category: 'Fries & Sides', price: 69, description: '', image: 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?auto=format&fit=crop&w=800&q=80', veg: true, rating: 4.9, calories: 290, time: '10 min', quantity: 1 },
      { id: 'thums-up', name: 'Thums Up', category: 'Beverages', price: 20, description: '', image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?auto=format&fit=crop&w=800&q=80', veg: true, rating: 4.8, calories: 120, time: '1 min', quantity: 1 }
    ],
    subtotal: 188,
    deliveryFee: 35,
    discount: 0,
    ...
    mode: 'Delivery',
    deliveryAddress: 'Flat 301, Kaveri Layout, Marathahalli Village, Bengaluru',
  ...
  },
  {
    id: 'BSK-352293',
    items: [
      { id: 'paneer-tikka-snack-pack', name: 'Paneer Tikka Snack Pack', category: 'Fusion Snack Pack', price: 120, description: '', image: 'https://images.unsplash.com/photo-1599488615731-7e5c2823ff28?auto=format&fit=crop&w=800&q=80', veg: true, rating: 4.8, calories: 480, time: '15 min', quantity: 2 }
    ],
    subtotal: 240,
    deliveryFee: 35,
    discount: 0,
    ...
    status: 'Preparing',
    mode: 'Delivery',
    deliveryAddress: 'Kalamandir Junction, Outer Ring Rd, Marathahalli, Bengaluru',
  ...
  },
  {
    id: 'BSK-123292',
    items: [
      { id: 'chicken-tikka-snack-pack', name: 'Chicken Tikka Snack Pack', category: 'Fusion Snack Pack', price: 120, description: '', image: 'https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&w=800&q=80', veg: false, rating: 4.9, calories: 590, time: '18 min', quantity: 3 },
      { id: 'tiramisu-cup', name: 'Tiramisu Cup', category: 'Desserts', price: 150, description: '', image: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?auto=format&fit=crop&w=800&q=80', veg: false, rating: 4.9, calories: 310, time: '5 min', quantity: 1 }
    ],
    subtotal: 510,
    deliveryFee: 0,
    discount: 50,
    ...
    mode: 'Takeaway',
    deliveryAddress: 'Self Takeaway Pickup (Kaveri Layout Outlet)',
    customerName: 'Vikram Seth',
    customerPhone: '9711233445',
